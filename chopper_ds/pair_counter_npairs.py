...
import os
import gc
from halotools.mock_observables.pair_counters import npairs_per_object_3d
...
def calculate_delta_sigma(halocat, particles, params, rank, rank_iter):
    ...
    result = npairs_per_object_3d(halos, ptcls, rbins, period=None, num_threads=ncores).astype('float32')
